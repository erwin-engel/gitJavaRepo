...
public class ConnectionPool {
  ...
  private static final String DBNAAM = "java:/comp/env/jdbc/EmailList";
   ...
   */
  private ConnectionPool() throws EmailException {
    try {
   ...
   * @throws EmailException
   */
  static synchronized ConnectionPool getInstance() throws EmailException {
    if (pool == null) {
   ...
   * @throws EmailException
   */
  Connection getConnection() throws EmailException {
    try {
   ...
   * @throws EmailException
   */
  void freeConnection(Connection c) throws EmailException {
    try {
      c.close();
    }
    catch (SQLException e) {
